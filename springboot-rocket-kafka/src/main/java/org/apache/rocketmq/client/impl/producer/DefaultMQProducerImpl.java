...
public class DefaultMQProducerImpl implements org.apache.rocketmq.client.impl.producer.MQProducerInner {
    private final InternalLogger log = ClientLogger.getLog();
    private final Random random = new Random();
    private final DefaultMQProducer defaultMQProducer;
    private final ConcurrentMap<String/* topic */, org.apache.rocketmq.client.impl.producer.TopicPublishInfo> topicPublishInfoTable =
        new ConcurrentHashMap<String, org.apache.rocketmq.client.impl.producer.TopicPublishInfo>();
